        ...
        <div>
            ...
            <main>
                <div className={styles.body}>
                    <h1 style={{"font-weight": "bold", textAlign: "center", fontSize: "2.4rem", padding: "1rem 0rem 0 0", margin: "0"}}>{name}</h1>
                    <h3 style={{textAlign: "center", paddingBottom: "2rem"}}>{title}</h3>
                    
                        <div className={styles.contactImage}>
                          <Image className={styles.profileImage}
                            alt="Profile Picture of Matthew McDaniel"
                            src="/assets/MatthewProfile.JPG"
                            quality={100}
                            layout="fill"
                            objectFit="cover"
                          />
                    ...
                    <div className={styles.buttonSpacing}>
                        <Link href='assets/MatthewMcDaniel.vcf' download>
